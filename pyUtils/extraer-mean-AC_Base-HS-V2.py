...
namePrefix = "/home/ayanez/Bici-Version-3/src/networks/scenario1/results/PlatoonSize-Umbral-withError-High-BaseN6" 
...
#~ for i in range(0,5):
	#~ Var2[0][i]=np.mean(ListG1[0][1][i])
	#~ Var2[1][i]=np.mean(ListG1[1][1][i])
