...
CustomMovingMobilityBase::CustomMovingMobilityBase()
{
    moveTimer = NULL;
    updateInterval = 0;
    stationary = false;
...
void CustomMovingMobilityBase::initialize(int stage)
{
...
void CustomMovingMobilityBase::moveAndUpdate()
{
...
void CustomMovingMobilityBase::handleSelfMessage(cMessage *message)
{
    moveAndUpdate();
    scheduleUpdate();
}

void CustomMovingMobilityBase::scheduleUpdate()
{
...
Coord CustomMovingMobilityBase::getCurrentPosition()
{
    //moveAndUpdate();
    return lastPosition;
}

Coord CustomMovingMobilityBase::getCurrentSpeed()
{
    //moveAndUpdate();
    return lastSpeed;
}
