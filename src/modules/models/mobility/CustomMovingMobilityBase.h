...
#ifndef CUSTOM_MOVING_MOBILITY_BASE_H
#define CUSTOM_MOVING_MOBILITY_BASE_H
 ...
 */
class INET_API CustomMovingMobilityBase : public MobilityBase
{
  protected:
  ...
  protected:
   CustomMovingMobilityBase();

    virtual ~CustomMovingMobilityBase();
